// zapao-logic.js - Specialized Logic for Zapão da Sorte (1-150)
...
function renderZapaoGrid() {
    ...
    for (let i = 1; i <= 150; i++) {
        const numStr = i.toString().padStart(3, '0'); // 001, 002, ..., 150
    ...
    console.log(`[Zapão] Rendered ${ZAPAO_CONFIG.totalNumbers} numbers (1-150).`);
}
